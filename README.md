...
Режим Last.fm подходит как запасной вариант, особенно если Spotify API недоступен. Подключить Spotify scrobbling к Last.fm, а виджет читает текущий трек через Last.fm.
